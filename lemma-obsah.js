...
window.LEMMA_CONTENT_BACKUP = {
  ...
  "courses": [
    {
      "id": "kurz-derivacie-doucko",
      "title": "Derivácie podľa postupu doučovateľa",
      "description": "Lekcie kopírujú spôsob vysvetľovania z doučovania: od významu funkcie a derivácie cez mocninové, exponenciálne a goniometrické vzorce až po reťazové pravidlo. Pokračovanie z Doučka 2 pridáva systematické rozoberanie viacnásobne vnorených funkcií, správne čítanie mocnín a odmocnín, záporné exponenty, kontrolu derivovanej premennej a deriváciu súčinu a podielu dvoch funkcií.",
      "icon": "∫",
      "custom": true,
      "lessonIds": [
        "derivacie-01-funkcia-a-zmena",
        "derivacie-02-zmena-na-prikladoch",
        "derivacie-03-mocniny-a-konstanty",
        "derivacie-04-exponencialy-a-trigonometria",
        "derivacie-05-retazove-pravidlo",
        "derivacie-06-retazove-pravidlo-priklady",
        "derivacie-07-mocniny-odmocniny-chytaky",
        "derivacie-08-sucin-a-podiel"
      ]
    },
    {
  ...
  "lessons": [
    ...
    {
      "id": "derivacie-01-funkcia-a-zmena",
      "courseId": "kurz-derivacie-doucko",
      "title": "1. Funkcia Derivácie ako dej",
      "custom": true,
      "maxScore": 7,
      "blocks": [
        {
        ...
        },
        {
          ...
          "content": [
            ...
            {
              "type": "text",
              "text": ". Ak je to dno doliny, ide o lokálne minimum. Keď vyjdete na vrchol, spravíte si selfie a potom začnete schádzať, ide o lokálne maximum."
            }
          ]
        },
        {
          ...
          "content": [
            {
              "type": "text",
              "text": "V stacionárnom bode je okamžitá zmena nulová. To neznamená, že funkcia má hodnotu nula. Znamená to, že jej graf je v danom okamihu vodorovný: prestal stúpať a ešte nezačal klesať, alebo naopak."
            }
          ]
        },
        {
        ...
        },
        {
          ...
          "content": [
            {
              "type": "text",
              "text": "Tesne pred šestkou môže graf padať k veľmi veľkým záporným hodnotám a tesne za šestkou prichádza z veľmi veľkých kladných hodnôt. V samotnom bode "
            },
            {
              "type": "formula",
              "tex": "x=6",
        ...
        },
        {
          ...
          "content": [
            {
              "type": "text",
              "text": "Funkcia priraďuje vstupu výsledok a jej graf môže opisovať reálny dej. Derivácia nebude iba ďalší vzorec: bude hovoriť, ako sa funkcia mení. Kladná derivácia znamená rast, záporná pokles a nulová derivácia často označuje stacionárny bod. Pred samotným počítaním preto vždy najprv rozmýšľame, čo sa na grafe deje."
            }
          ]
        },
        {
    ...
    {
      "id": "derivacie-02-zmena-na-prikladoch",
      "courseId": "kurz-derivacie-doucko",
      "title": "2. Derivácia ako zmena: 3, x + 1 a ln x",
      "custom": true,
      "maxScore": 7,
      "blocks": [
        {
          ...
          "content": [
            {
              "type": "text",
              "text": "Teraz spravíme presne to, čo doučovateľ robil na tabuli: nezačneme zoznamom vzorcov. Vyberieme si na grafe malý krok, zmeníme vstup a pozrieme sa, čo sa stalo s výstupom."
            }
          ]
        },
        {
        ...
        },
        {
          ...
          "content": [
            {
              "type": "text",
              "text": "Môže byť samotné číslo 3 funkciou? Áno. Je to veľmi jednoduchá funkcia, ktorá pre každý vstup vráti tú istú hodnotu. Matematik si v nej vie predstaviť aj premennú: "
            },
            {
              "type": "formula",
              "tex": "f(x)=3x^0",
            ...
            {
              "type": "text",
              "text": " pre každý prípustný nenulový vstup."
            }
          ]
        },
        {
        ...
        },
        {
          ...
          "content": [
            {
              "type": "text",
              "text": "Takto čítame výsledok: konštantná funkcia sa nemení, preto je jej derivácia nula. Nula tu nie je trest za to, že vo výraze nevidíme "
            },
            {
              "type": "formula",
              "tex": "x",
            ...
            {
              "type": "text",
              "text": ". Je to presná informácia o grafe: nech sa na osi "
            },
            {
              "type": "formula",
              "tex": "x",
        ...
        },
        {
          ...
          "content": [
            ...
            {
              "type": "text",
              "text": " dostaneme 3. Vždy, keď vstup zväčšíme o jednotku, výstup sa zväčší tiež o jednotku."
            }
          ]
        },
        {
        ...
        },
        {
          ...
          "content": [
            {
              "type": "text",
              "text": "Pri prvých dvoch príkladoch vyšla derivácia 0 alebo 1. To môže vytvoriť nesprávny dojem, že derivácia je vždy jedno číslo. Nie je. Keď sa sklon pôvodného grafu mení z miesta na miesto, výsledkom derivovania je nová funkcia."
            }
          ]
        },
        {
        ...
        },
        {
          ...
          "content": [
            ...
            {
              "type": "text",
              "text": " graf narastie citeľne. Z 2 do 3 narastie menej. Z 4 do 5 ešte menej. Derivácia musí túto povahu zachytiť: pri malých kladných "
            },
            {
              "type": "formula",
              "tex": "x",
        ...
        },
        {
          ...
          "content": [
            ...
            {
              "type": "text",
              "text": " presne hovorí, aká veľká je okamžitá zmena logaritmu. Pri "
            },
            {
              "type": "formula",
              "tex": "x=1",
            ...
            {
              "type": "text",
              "text": ". Logaritmus teda stále stúpa, ale čím ďalej, tým pomalšie."
            }
          ]
        },
        {
          ...
          "content": [
            {
              "type": "text",
              "text": "Grafický experiment: pôvodná funkcia a funkcia jej zmeny"
            }
          ]
        },
        {
          ...
          "content": [
            {
              "type": "text",
              "text": "Posúvajte bod po logaritme. Modrý bod ukazuje hodnotu "
            },
            {
              "type": "formula",
              "tex": "\\ln x",
            ...
            {
              "type": "text",
              "text": ", červený bod hodnotu derivácie "
            },
            {
              "type": "formula",
              "tex": "\\frac1x",
            ...
            {
              "type": "text",
              "text": ". Nesledujte iba číslo na posuvníku. Sledujte, ako sa modrý graf splošťuje práve vtedy, keď červený graf klesá."
            }
          ]
        },
        {
          ...
          "tasks": [
            {
              ...
              "condition": "a>0.95 && a<1.05 && g(a)>0.95 && g(a)<1.05"
            },
            {
    ...
    {
      "id": "derivacie-03-mocniny-a-konstanty",
      "courseId": "kurz-derivacie-doucko",
      "title": "3. Mocniny a polynómy: zhoď exponent, konštantu rozlíš",
      "custom": true,
      "maxScore": 8,
      "blocks": [
        {
          ...
          "content": [
            {
              "type": "text",
              "text": "Teraz už vieme, čo derivácia znamená. Ideme na výpočtový postup, ktorý doučovateľ opakoval: pozrieť sa, aký typ člena máme, vybrať správne pravidlo a dávať veľký pozor na rozdiel medzi samostatnou konštantou a číslom pri premennej."
            }
          ]
        },
        {
        ...
        },
        {
          ...
          "content": [
            {
              "type": "text",
              "text": "Pre mocninovú funkciu používame pravidlo"
            }
          ]
        },
        {
        ...
        },
        {
          ...
          "content": [
            {
              "type": "text",
              "text": "Doučovateľský postup sa dá povedať veľmi jednoducho: číslo z exponentu "
            },
            {
              "type": "text",
        ...
        },
        {
          ...
          "content": [
            ...
            {
              "type": "text",
              "text": " nie je oddelená mágia. Je to osobitný prípad mocninového pravidla."
            }
          ]
        },
        {
        ...
        },
        {
          ...
          "content": [
            ...
            {
              "type": "text",
              "text": ". Dvadsiatka sama nie je funkciou, ktorú teraz derivujeme; je to stály násobok pri "
            },
            {
              "type": "formula",
              "tex": "x^4",
        ...
        },
        {
          ...
          "tasks": [
            ...
            {
              "text": "Vytvorte lineárnu funkciu so záporným sklonom. Overte, že červený graf je vodorovný a jeho hodnota sa zhoduje s koeficientom pôvodnej priamky.",
              "condition": "abs(n-1)<0.001 && c<0 && abs(g(a)-c)<0.001"
            },
            {
              "text": "Nastavte vyššiu mocninu a nájdite bod, v ktorom je derivácia záporná. Sledujte, či modrý graf v tomto bode naozaj klesá.",
              "condition": "n>=2 && a<0 && g(a)<-0.2"
            }
          ],
          "expected": [
            "c",
    ...
    {
      "id": "derivacie-04-exponencialy-a-trigonometria",
      "courseId": "kurz-derivacie-doucko",
      "title": "4. Exponenciály a sínus: vzorec musí hovoriť o grafe",
      "custom": true,
      "maxScore": 8,
      "blocks": [
        {
          ...
          "content": [
            {
              "type": "text",
              "text": "Papier so vzorcami môžete mať pred sebou. Ale doučovateľ upozorňuje: samotný papier vám nepomôže, ak neviete, čo je základ, čo je exponent, čo je argument funkcie a čo derivácia o grafe hovorí."
            }
          ]
        },
        {
        ...
        },
        {
          ...
          "content": [
            ...
            {
              "type": "text",
              "text": ", kde je premenný základ a konštantný exponent."
            }
          ]
        },
        {
        ...
        },
        {
          ...
          "content": [
            {
              "type": "text",
              "text": "Prehľad jednoduchých tvarov z priloženého PDF"
            }
          ]
        },
        {
          ...
          "content": [
            {
              "type": "text",
              "text": "Nasledujúci blok je prehľad. Neučte sa ho ako pätnásť nesúvisiacich riadkov. Pri každom vzorci si všimnite pôvodnú funkciu, výslednú funkciu a znamienko."
            }
          ]
        },
        {
          "type": "formula",
          "tex": "\\begin{aligned}(c)'&=0 &(x)'&=1 &(x^a)'&=ax^{a-1}\\\\(a^x)'&=a^x\\ln a &(e^x)'&=e^x &(\\log_a x)'&=\\frac{1}{x\\ln a}\\\\(\\ln x)'&=\\frac1x &(\\sin x)'&=\\cos x &(\\cos x)'&=-\\sin x\\\\(\\tan x)'&=\\frac{1}{\\cos^2x} &(\\cot x)'&=-\\frac{1}{\\sin^2x}\\\\(\\arcsin x)'&=\\frac{1}{\\sqrt{1-x^2}} &(\\arccos x)'&=-\\frac{1}{\\sqrt{1-x^2}}\\\\(\\arctan x)'&=\\frac{1}{1+x^2} &(\\operatorname{arccot}x)'&=-\\frac{1}{1+x^2}\\end{aligned}",
          "display": "block",
          "tts": false
        },
        {
          ...
          "content": [
            {
              "type": "text",
              "text": "Pri arkusfunkciách ide o inverzné funkcie k sínusu, kosínusu, tangensu a kotangensu. Na začiatku je najdôležitejšie vedieť ich správne nájsť v prehľade a nerozmiešať znamienka."
            }
          ]
        },
        {
        ...
        },
        {
          ...
          "content": [
            ...
            {
              "type": "text",
              "text": " je výnimočná tým, že sa derivovaním nemení. Pri sínuse je deriváciou kosínus: na vrchole a dne je zmena nulová, pri najstrmšom raste kladná a pri najstrmšom poklese záporná. Vzorce majú hovoriť príbeh grafu, nie zostať iba na papieri."
            }
          ]
        },
        {
    ...
    {
      "id": "derivacie-05-retazove-pravidlo",
      "courseId": "kurz-derivacie-doucko",
      "title": "5. Zložená funkcia: skrytá jednotka a reťazové pravidlo",
      "custom": true,
      "maxScore": 10,
      "blocks": [
        {
          ...
          "content": [
            {
              "type": "text",
              "text": "Teraz prichádza presne ten dôvod, prečo samotný prehľad jednoduchých vzorcov nestačí. V tabuľke vidíte napríklad "
            },
            {
              "type": "formula",
              "tex": "(\\sin x)'=\\cos x",
        ...
        },
        {
          ...
          "content": [
            {
              "type": "text",
              "text": "Matka a dieťa: vonkajšia a vnútorná funkcia"
            }
          ]
        },
        {
          ...
          "content": [
            {
              "type": "text",
              "text": "Doučovateľ používa obraz matky a dieťaťa. Sínus je vonkajšia funkcia, ktorá v sebe nesie argument. Pri "
            },
            {
              "type": "formula",
              "tex": "\\sin(x^2+6x-3)",
            ...
            {
              "type": "text",
              "text": " je vonkajšia funkcia sínus a vo vnútri je dieťa "
            },
            {
              "type": "formula",
              "tex": "u(x)=x^2+6x-3",
        ...
        },
        {
          ...
          "content": [
            {
              "type": "text",
              "text": "Úplné tvary zo vzorcového PDF"
            }
          ]
        },
        {
          ...
          "content": [
            {
              "type": "text",
              "text": "V PDF je táto „skrytá časť“ rozpísaná priamo. V každom riadku vidíte rovnaký vzor: zderivujeme vonkajší obal, celý vnútorný výraz ponecháme na jeho miestach a nakoniec násobíme "
            },
            {
              "type": "formula",
              "tex": "u'(x)",
        ...
        },
        {
          ...
          "content": [
            ...
            {
              "type": "text",
              "text": " vonkajší vzorec vytvorí zlomok s pôvodným vnútrom v menovateli a deriváciou vnútra v čitateli."
            }
          ]
        },
        {
    ...
    {
      "id": "derivacie-06-retazove-pravidlo-priklady",
      "courseId": "kurz-derivacie-doucko",
      "title": "6. Reťazové pravidlo v praxi: rozoberanie funkcie ako cibule",
      "custom": true,
      "maxScore": 7,
      "blocks": [
        {
          ...
          "content": [
            {
              "type": "text",
              "text": "V druhom doučovaní sa už nejde iba po jednom vzorci. Hlavnou úlohou je "
            },
            {
              "type": "text",
              "text": "rozobrať štruktúru funkcie",
              "marks": [
                "bold"
              ]
            },
            {
              "type": "text",
              "text": ", rozpoznať všetky vrstvy a postupne ich derivovať zvonka dovnútra. Doučovateľ to prirovnáva k cibuli: každá šupka pridá do výsledku ďalší faktor."
            }
          ]
        },
        {
          ...
          "content": [
            {
              "type": "text",
              "text": "Najprv skontrolujte, kde je premenná"
            }
          ]
        },
        {
          ...
          "content": [
            {
              "type": "text",
              "text": "Skôr než začnete hľadať vzorce, overte, či sa v zadaní vôbec nachádza derivovaná premenná. Ak tam nie je, celý výraz je z pohľadu tejto premennej konštanta a jeho derivácia je nula. Ak tam premenná je, označte si vonkajší obal a jeho argument."
            }
          ]
        },
        {
        ...
        },
        {
          ...
          "content": [
            {
              "type": "text",
              "text": "Vonkajšia funkcia je kosínus. Celý argument "
            },
            {
              "type": "formula",
              "tex": "6x^3-\\ln x+8",
            ...
            {
              "type": "text",
              "text": " sa najprv iba opíše a až potom sa derivuje člen po člene."
            }
          ]
        },
        {
          "type": "formula",
          "tex": "\\begin{aligned}f'(x)&=-\\sin(6x^3-\\ln x+8)\\cdot(6x^3-\\ln x+8)'\\\\&=-\\sin(6x^3-\\ln x+8)\\left(18x^2-\\frac1x\\right).\\end{aligned}",
          "display": "block",
          "tts": false
        },
        {
          ...
          "content": [
            ...
            {
              "type": "text",
              "text": " sa opíše, pretože násobí funkciu. Samostatná konštanta 8 sa zmení na nulu. Znamienko mínus pred "
            },
            {
              "type": "formula",
              "tex": "\\ln x",
        ...
        },
        {
          ...
          "content": [
            {
              "type": "text",
              "text": "Príklad 2: pozor na druhú mocninu argumentu"
            }
          ]
        },
        {
          ...
          "content": [
            ...
            {
              "type": "text",
              "text": " nie je argumentom arkustangensu čisté "
            },
            {
              "type": "formula",
              "tex": "x",
            ...
            {
              "type": "text",
              "text": ". Vo vzorci preto musí zostať celý argument a následne aj jeho derivácia."
            }
          ]
        },
        {
          "type": "formula",
          "tex": "\\begin{aligned}g'(x)&=5\\cdot\\frac{1}{1+(x^2)^2}\\cdot(x^2)'\\\\&=5\\cdot\\frac{1}{1+x^4}\\cdot2x=\\frac{10x}{1+x^4}.\\end{aligned}",
          "display": "block",
          "tts": false
        },
        {
          ...
          "content": [
            {
              "type": "text",
              "text": "Častá chyba je napísať iba "
            },
            {
              "type": "formula",
              "tex": "5/(1+x^2)",
            ...
            {
              "type": "text",
              "text": ". To by zodpovedalo funkcii "
            },
            {
              "type": "formula",
              "tex": "5\\arctan x",
        ...
        },
        {
          ...
          "content": [
            {
              "type": "text",
              "text": "Tri vnorené vrstvy: princíp cibule"
            }
          ]
        },
        {
        ...
        {
          "type": "formula",
          "tex": "h(x)=\\arcsin\\!\\left(\\log_5(\\cos(3x+6))\\right).",
          "display": "block",
          "tts": false
        },
        {
          ...
          "content": [
            {
              "type": "text",
              "text": "Vrstvy čítame zvonka dovnútra: "
            },
            {
              "type": "text",
              "text": "arkussínus",
            ...
            {
              "type": "text",
              "text": ". Pri derivovaní postupujeme v rovnakom poradí a každá vrstva pridá svoj faktor."
            }
          ]
        },
        {
          "type": "formula",
          "tex": "\\begin{aligned}h'(x)&=\\frac{1}{\\sqrt{1-\\left(\\log_5(\\cos(3x+6))\\right)^2}}\\\\&\\quad\\cdot\\frac{1}{\\cos(3x+6)\\ln5}\\\\&\\quad\\cdot\\bigl(-\\sin(3x+6)\\bigr)\\cdot3.\\end{aligned}",
          "display": "block",
          "tts": false
        },
        {
        ...
        },
        {
          ...
          "content": [
            {
              "type": "text",
              "text": "Reťazové pravidlo opakujete dovtedy, kým poslednú vnútornú časť neviete zderivovať základnými pravidlami. Pri "
            },
            {
              "type": "formula",
              "tex": "3x+6",
            ...
            {
              "type": "text",
              "text": ". V tejto chvíli ste sa dostali k jadru cibule."
            }
          ]
        },
        {
          ...
          "content": [
            ...
            {
              "type": "text",
              "text": " 1. označte vonkajšiu funkciu; 2. opíšte celý jej argument; 3. pridajte deriváciu argumentu; 4. ak je argument zložený, zopakujte postup; 5. skončite až pri základných členoch."
            }
          ]
        },
        {
        ...
        },
        {
          ...
          "content": [
            {
              "type": "text",
              "text": "Po výpočte overte tri veci: či ste v každej vrstve opísali "
            },
            {
              "type": "text",
              "text": "celý argument",
            ...
            {
              "type": "text",
              "text": ", či ste nezabudli na "
            },
            {
              "type": "text",
              "text": "vnútornú deriváciu",
              "marks": [
                "bold"
              ]
            },
            {
              "type": "text",
              "text": " a či ste správne ponechali zátvorky a mocniny. Pri zložitých príkladoch je bezpečnejšie nechať výsledok ako súčin faktorov, než ho nasilu upravovať."
            }
          ]
        },
        {
          "type": "test",
          "title": "Reťazové pravidlo na viacerých vrstvách",
          "source": "# Reťazové pravidlo na viacerých vrstvách\n\n[ABCD]\nAká je vonkajšia funkcia vo výraze cos(6x³-ln x+8)?\n* kosínus\n- 6x³\n- prirodzený logaritmus\n- súčet\n\n[ABCD]\nKtorá derivácia funkcie cos(6x³-ln x+8) je správna?\n- -sin(18x²-1/x)\n* -sin(6x³-ln x+8)(18x²-1/x)\n- cos(6x³-ln x+8)(18x²-1/x)\n- -sin(6x³-ln x+8)(18x²+8)\n\n[ABCD]\nČo musí byť v menovateli pri derivovaní arctan(x²)?\n- 1+x²\n* 1+(x²)²\n- 1+2x\n- (1+x)²\n\n[ODPOVEĎ]\nZderivuj 5 arctan(x²).\n= 10x/(1+x^4) | \\frac{10x}{1+x^4} | (10x)/(1+x^4)\n\n[ABCD]\nV akom poradí derivujeme arcsin(log₅(cos(3x+6)))?\n* arcsin, potom logaritmus, potom kosínus, potom 3x+6\n- 3x+6, potom kosínus, potom logaritmus, potom arcsin\n- iba arcsin\n- logaritmus, potom arcsin, potom kosínus\n\n[DROPDOWN]\nReťazové pravidlo končí, keď vnútornú časť vieme zderivovať pomocou {{výber}} pravidiel.\n* základných\n- podielových\n- integračných\n- geometrických\n\n[ABCD]\nPrečo sa samostatná osmička vo vnútri príkladu zmení na nulu?\n- Pretože je párna.\n- Pretože je v kosínuse.\n* Pretože jej derivácia podľa x je nula.\n- Pretože je kladná.",
          "maxScore": 7,
          "tts": false
        }
      ],
    ...
    {
      "id": "derivacie-07-mocniny-odmocniny-chytaky",
      "courseId": "kurz-derivacie-doucko",
      "title": "7. Mocniny, odmocniny a chytáky v zápise",
      "custom": true,
      "maxScore": 7,
      "blocks": [
        {
          ...
          "content": [
            {
              "type": "text",
              "text": "V komplikovanejších zadaniach často nie je najťažší samotný derivačný vzorec, ale správne prečítanie zápisu. Druhé doučovanie preto zdôrazňuje mocniny celých funkcií, odmocniny, záporné exponenty a prvú kontrolnú otázku: "
            },
            {
              "type": "text",
              "text": "Je v zadaní vôbec derivovaná premenná?",
              "marks": [
                "bold"
              ]
            }
        ...
        },
        {
          ...
          "content": [
            {
              "type": "text",
              "text": "Mocnina funkcie nie je mocnina argumentu"
            }
          ]
        },
        {
          ...
          "content": [
            ...
            {
              "type": "text",
              "text": " neznamenajú to isté. V prvom prípade je na druhú umocnený výsledok logaritmu. V druhom prípade patrí druhá mocnina argumentu vo vnútri logaritmu."
            }
          ]
        },
        {
          "type": "formula",
          "tex": "\\begin{aligned}\\bigl((\\ln x)^2\\bigr)'&=2\\ln x\\cdot\\frac1x,\\\\\\bigl(\\ln(x^2)\\bigr)'&=\\frac{1}{x^2}\\cdot2x=\\frac2x.\\end{aligned}",
          "display": "block",
          "tts": false
        },
        {
          ...
          "content": [
            {
              "type": "text",
              "text": "Zátvorky určujú, koho sa mocnina týka. Pri nejasnom zápise si ich pred derivovaním doplňte."
            }
          ]
        },
        {
          ...
          "content": [
            {
              "type": "text",
              "text": "Odmocninu prepíšte na mocninu"
            }
          ]
        },
        {
          ...
          "content": [
            {
              "type": "text",
              "text": "Ak pre odmocninu nemáte samostatný vzorec, prepíšte ju pomocou zlomkového exponentu. Príklad z doučovania možno zapísať ako"
            }
          ]
        },
        {
          "type": "formula",
          "tex": "F(x)=\\sqrt[4]{\\bigl(\\ln(\\cos(x+5))\\bigr)^3}=\\bigl(\\ln(\\cos(x+5))\\bigr)^{3/4}.",
          "display": "block",
          "tts": false
        },
        {
          ...
          "content": [
            {
              "type": "text",
              "text": "Najvrchnejšou vrstvou je teraz mocnina "
            },
            {
              "type": "formula",
              "tex": "3/4",
            ...
            {
              "type": "text",
              "text": ". Potom nasleduje prirodzený logaritmus, kosínus a napokon výraz "
            },
            {
              "type": "formula",
              "tex": "x+5",
        ...
        {
          "type": "formula",
          "tex": "\\begin{aligned}F'(x)&=\\frac34\\bigl(\\ln(\\cos(x+5))\\bigr)^{-1/4}\\\\&\\quad\\cdot\\frac{1}{\\cos(x+5)}\\cdot\\bigl(-\\sin(x+5)\\bigr)\\cdot1.\\end{aligned}",
          "display": "block",
          "tts": false
        },
        {
          ...
          "content": [
            {
              "type": "text",
              "text": "Exponent po derivovaní znížime o jednotku: "
            },
            {
              "type": "formula",
              "tex": "\\frac34-1=-\\frac14",
            ...
            {
              "type": "text",
              "text": ". Výsledok netreba hneď komplikovane upravovať; dôležité je, aby obsahoval faktor z každej vrstvy."
            }
          ]
        },
        {
          ...
          "content": [
            {
              "type": "text",
              "text": "Premenná v menovateli: použite záporný exponent"
            }
          ]
        },
        {
          ...
          "content": [
            ...
            {
              "type": "text",
              "text": " prepíšeme tak, aby sa dal použiť mocninový vzorec."
            }
          ]
        },
        {
        ...
        {
          "type": "formula",
          "tex": "\\left(3x^{-4}\\right)'=3\\cdot(-4)x^{-5}=-12x^{-5}=-\\frac{12}{x^5}.",
          "display": "block",
          "tts": false
        },
        {
          ...
          "content": [
            {
              "type": "text",
              "text": "Pri presune mocniny cez zlomkovú čiaru sa zmení znamienko exponentu. Potom už postupujeme rovnako ako pri každej inej mocnine."
            }
          ]
        },
        {
          ...
          "content": [
            {
              "type": "text",
              "text": "Chyták: zložitý zápis bez premennej"
            }
          ]
        },
        {
          ...
          "content": [
            {
              "type": "text",
              "text": "Aj veľmi komplikovaný výraz môže byť iba číslo. Ak derivujeme podľa "
            },
            {
              "type": "formula",
              "tex": "x",
            ...
            {
              "type": "text",
              "text": " nenachádza, derivácia je nula — bez ohľadu na odmocniny, mocniny, číslo "
            },
            {
              "type": "formula",
              "tex": "\\pi",
            ...
            {
              "type": "text",
              "text": " či logaritmy konštánt."
            }
          ]
        },
        {
          "type": "formula",
          "tex": "\\left(\\sqrt[3]{\\pi^2+7}\\right)'=0",
          "display": "block",
          "tts": false
        },
        {
          ...
          "content": [
            {
              "type": "text",
              "text": "Toto kontrolujte ešte pred rozpisovaním vzorcov. Ušetrí vám to zbytočný výpočet."
            }
          ]
        },
        {
        ...
        },
        {
          ...
          "content": [
            {
              "type": "text",
              "text": "Vo fyzike alebo technických predmetoch môžete derivovať podľa "
            },
            {
              "type": "formula",
              "tex": "t",
            ...
            {
              "type": "text",
              "text": " alebo inej premennej. Vzorce zostávajú rovnaké; len si v nich namiesto všeobecného "
            },
            {
              "type": "formula",
              "tex": "x",
            ...
            {
              "type": "text",
              "text": " predstavíte premennú uvedenú v zadaní."
            }
          ]
        },
        {
          "type": "formula",
          "tex": "\\frac{d}{dt}(5t^3-2z)=15t^2",
          "display": "block",
          "tts": false
        },
        {
          ...
          "content": [
            ...
            {
              "type": "text",
              "text": " považuje za konštantu, pokiaľ zadanie nehovorí, že závisí od "
            },
            {
              "type": "formula",
              "tex": "t",
        ...
        },
        {
          ...
          "content": [
            {
              "type": "text",
              "text": "Rýchly rozhodovací postup"
            }
          ]
        },
        {
          ...
          "content": [
            ...
            {
              "type": "text",
              "text": " Určte, podľa ktorej premennej derivujete. "
            },
            {
              "type": "text",
              "text": "2.",
            ...
            {
              "type": "text",
              "text": " Nájdite túto premennú vo výraze. "
            },
            {
              "type": "text",
              "text": "3.",
            ...
            {
              "type": "text",
              "text": " Doplňte zátvorky, aby bolo jasné, čo je umocnené. "
            },
            {
              "type": "text",
              "text": "4.",
            ...
            {
              "type": "text",
              "text": " Odmocniny a premenné v menovateli prepíšte na mocniny. "
            },
            {
              "type": "text",
              "text": "5.",
            ...
            {
              "type": "text",
              "text": " Až potom použite mocninové a reťazové pravidlo."
            }
          ]
        },
        {
          "type": "test",
          "title": "Mocniny, odmocniny a kontrola premennej",
          "source": "# Mocniny, odmocniny a kontrola premennej\n\n[ABCD]\nKtorý zápis znamená, že celý prirodzený logaritmus je umocnený na druhú?\n* (ln x)²\n- ln(x²)\n- ln(2x)\n- 2ln x\n\n[ABCD]\nNa akú mocninu prepíšeme štvrtú odmocninu z tretiej mocniny výrazu u(x)?\n- u(x)^(4/3)\n* u(x)^(3/4)\n- u(x)^(-3/4)\n- u(x)^7\n\n[ABCD]\nAký exponent vznikne po derivovaní u(x)^(3/4)?\n- 1/4\n* -1/4\n- 3/4\n- -3/4\n\n[ODPOVEĎ]\nZderivuj 3/x⁴.\n= -12/x^5 | -12x^(-5) | -12*x^(-5) | \\frac{-12}{x^5}\n\n[ABCD]\nČomu sa rovná derivácia výrazu, ktorý neobsahuje derivovanú premennú?\n* 0\n- 1\n- samotnému výrazu\n- Nedá sa určiť.\n\n[ABCD]\nDerivujeme podľa t. Ako sa pri výraze 5t³-2z správa člen -2z, ak z nezávisí od t?\n- Jeho derivácia je -2.\n- Jeho derivácia je z.\n* Jeho derivácia je 0.\n- Musí sa použiť podielové pravidlo.\n\n[DROPDOWN]\nVýraz 1/x⁶ možno pred derivovaním prepísať ako {{výber}}.\n- x⁶\n* x⁻⁶\n- -x⁶\n- 6x",
          "maxScore": 7,
          "tts": false
        }
      ],
    ...
    {
      "id": "derivacie-08-sucin-a-podiel",
      "courseId": "kurz-derivacie-doucko",
      "title": "8. Derivácia súčinu a podielu dvoch funkcií",
      "custom": true,
      "maxScore": 7,
      "blocks": [
        {
          ...
          "content": [
            {
              "type": "text",
              "text": "Doteraz sme derivovali jednu funkciu — hoci mohla mať veľa vnorených vrstiev. Teraz sú vedľa seba dve funkcie spojené násobením alebo delením. Tu už nestačí zderivovať každú časť osobitne a medzi výsledkami ponechať pôvodný znak."
            }
          ]
        },
        {
        ...
        },
        {
          ...
          "content": [
            {
              "type": "text",
              "text": "Pri súčte a rozdiele platí derivovanie člen po člene:"
            }
          ]
        },
        {
          "type": "formula",
          "tex": "(u+v)'=u'+v',\\qquad (u-v)'=u'-v'.",
          "display": "block",
          "tts": false
        },
        {
          ...
          "content": [
            {
              "type": "text",
              "text": "Pri súčine však všeobecne neplatí "
            },
            {
              "type": "formula",
              "tex": "(uv)'=u'v'",
            ...
            {
              "type": "text",
              "text": ". Správne pravidlo obsahuje dva členy."
            }
          ]
        },
        {
        ...
        },
        {
          ...
          "content": [
            {
              "type": "text",
              "text": "Slovami: derivácia prvej krát druhá bez derivovania, plus prvá bez derivovania krát derivácia druhej."
            }
          ]
        },
        {
          ...
          "content": [
            {
              "type": "text",
              "text": "Bezpečný zápis so štyrmi zátvorkami"
            }
          ]
        },
        {
          ...
          "content": [
            {
              "type": "text",
              "text": "Doučovateľ odporúča najprv pripraviť kostru"
            }
          ]
        },
        {
          "type": "formula",
          "tex": "(\\square)'(\\square)+(\\square)(\\square)'",
          "display": "block",
          "tts": false
        },
        {
          ...
          "content": [
            {
              "type": "text",
              "text": "a až potom do nej vpísať funkcie. Tento postup chráni pred stratou zátvoriek, najmä keď sú obe funkcie zložené."
            }
          ]
        },
        {
        ...
        {
          "type": "formula",
          "tex": "\\begin{aligned}p'(x)&=(x^2+1)'\\sin x+(x^2+1)(\\sin x)'\\\\&=2x\\sin x+(x^2+1)\\cos x.\\end{aligned}",
          "display": "block",
          "tts": false
        },
        {
          ...
          "content": [
            {
              "type": "text",
              "text": "Každý z dvoch členov obsahuje jednu derivovanú a jednu pôvodnú funkciu."
            }
          ]
        },
        {
        ...
        },
        {
          ...
          "content": [
            {
              "type": "text",
              "text": "Pre podiel vytvoríme podobnú kostru, ale medzi členmi v čitateli je mínus a celý menovateľ sa umocní na druhú."
            }
          ]
        },
        {
        ...
        },
        {
          ...
          "content": [
            {
              "type": "text",
              "text": "Poradie v čitateli je dôležité: "
            },
            {
              "type": "text",
              "text": "derivácia čitateľa krát menovateľ mínus čitateľ krát derivácia menovateľa",
              "marks": [
                "bold"
              ]
            },
        ...
        },
        {
          ...
          "content": [
            {
              "type": "text",
              "text": "Jednoduchý príklad podielu"
            }
          ]
        },
        {
          "type": "formula",
          "tex": "q(x)=\\frac{\\ln x}{x^2+1}",
          "display": "block",
          "tts": false
        },
        {
          "type": "formula",
          "tex": "\\begin{aligned}q'(x)&=\\frac{(\\ln x)'(x^2+1)-\\ln x\\,(x^2+1)'}{(x^2+1)^2}\\\\&=\\frac{\\frac1x(x^2+1)-2x\\ln x}{(x^2+1)^2}.\\end{aligned}",
          "display": "block",
          "tts": false
        },
        {
          ...
          "content": [
            {
              "type": "text",
              "text": "Zložitý príklad zložený z viacerých pravidiel"
            }
          ]
        },
        {
          ...
          "content": [
            {
              "type": "text",
              "text": "Druhé doučovanie ukazuje, že podielové pravidlo iba vytvorí vonkajšiu kostru. Vnútri čitateľa a menovateľa potom ďalej používame súčet, logaritmus, exponenciálu, kosínus aj reťazové pravidlo. Uvažujme"
            }
          ]
        },
        {
          "type": "formula",
          "tex": "r(x)=\\frac{\\log_7(e^{3x})+\\cos x}{\\arcsin(x^2)}.",
          "display": "block",
          "tts": false
        },
        {
          ...
          "content": [
            ...
            {
              "type": "text",
              "text": ". Najprv ich zderivujeme samostatne."
            }
          ]
        },
        {
          "type": "formula",
          "tex": "\\begin{aligned}U'(x)&=\\frac{1}{e^{3x}\\ln7}\\cdot e^{3x}\\cdot3-\\sin x\\\\&=\\frac3{\\ln7}-\\sin x,\\\\V'(x)&=\\frac{1}{\\sqrt{1-(x^2)^2}}\\cdot2x=\\frac{2x}{\\sqrt{1-x^4}}.\\end{aligned}",
          "display": "block",
          "tts": false
        },
        {
          ...
          "content": [
            {
              "type": "text",
              "text": "Až potom ich vložíme do kostry podielového pravidla."
            }
          ]
        },
        {
          "type": "formula",
          "tex": "\\begin{aligned}r'(x)=\\frac{\\left(\\frac3{\\ln7}-\\sin x\\right)\\arcsin(x^2)-\\left(\\log_7(e^{3x})+\\cos x\\right)\\frac{2x}{\\sqrt{1-x^4}}}{\\left(\\arcsin(x^2)\\right)^2}.\\end{aligned}",
          "display": "block",
          "tts": false
        },
        {
          ...
          "content": [
            {
              "type": "text",
              "text": "Kedy špeciálne pravidlo netreba"
            }
          ]
        },
        {
          ...
          "content": [
            {
              "type": "text",
              "text": "Ak je jeden faktor iba konštanta, stačí ju opísať:"
            }
          ]
        },
        {
        ...
        },
        {
          ...
          "content": [
            {
              "type": "text",
              "text": "Použiť súčinové pravidlo by síce viedlo k rovnakému výsledku, ale zbytočne by ste vytvorili člen s deriváciou konštanty, teda s nulou."
            }
          ]
        },
        {
          ...
          "content": [
            {
              "type": "text",
              "text": "Finálny checklist pre súčin a podiel"
            }
          ]
        },
        {
          ...
          "content": [
            ...
            {
              "type": "text",
              "text": " Rozdeľte výraz na dve hlavné funkcie. "
            },
            {
              "type": "text",
              "text": "2.",
            ...
            {
              "type": "text",
              "text": " Napíšte prázdnu kostru pravidla. "
            },
            {
              "type": "text",
              "text": "3.",
            ...
            {
              "type": "text",
              "text": " Najprv doplňte nederivované kópie funkcií. "
            },
            {
              "type": "text",
              "text": "4.",
            ...
            {
              "type": "text",
              "text": " Potom osobitne vypočítajte derivované časti. "
            },
            {
              "type": "text",
              "text": "5.",
            ...
            {
              "type": "text",
              "text": " Skontrolujte znamienko mínus pri podiele a druhú mocninu celého menovateľa. "
            },
            {
              "type": "text",
              "text": "6.",
            ...
            {
              "type": "text",
              "text": " Každú zloženú časť ďalej rozoberajte reťazovým pravidlom."
            }
          ]
        },
        {
          "type": "test",
          "title": "Súčinové a podielové pravidlo",
          "source": "# Súčinové a podielové pravidlo\n\n[ABCD]\nKtorý vzorec je správny pre deriváciu súčinu u(x)v(x)?\n- u'v'\n* u'v+uv'\n- u'+v'\n- uv'+u'v'\n\n[ABCD]\nKtorý vzorec je správny pre deriváciu podielu u/v?\n* (u'v-uv')/v²\n- (u'v+uv')/v²\n- (u'v-uv')/u²\n- u'/v'\n\n[ABCD]\nAká je derivácia (x²+1)sin x?\n- 2x cos x\n* 2x sin x+(x²+1)cos x\n- (x²+1)cos x\n- 2x sin x+cos x\n\n[ABCD]\nČo musí byť v menovateli derivácie funkcie ln x/(x²+1)?\n- x²+1\n- 2x\n* (x²+1)²\n- (ln x)²\n\n[ABCD]\nPrečo je vhodné najprv napísať prázdnu kostru súčinového alebo podielového pravidla?\n- Aby sa zmenila premenná.\n* Aby sme nestratili poradie členov a zátvorky.\n- Aby sa všetky konštanty zmenili na 1.\n- Aby sme nemuseli derivovať vnútorné funkcie.\n\n[DROPDOWN]\nV čitateli podielového pravidla je medzi dvoma členmi znamienko {{výber}}.\n- plus\n* mínus\n- krát\n- delené\n\n[ABCD]\nAk je c konštanta, derivácia c·u(x) je:\n- c'u'\n- 0\n* c·u'(x)\n- u'(x)/c",
          "maxScore": 7,
          "tts": false
        }
      ],
  ...
  "appVersion": "V12",
  "backupCreatedAt": "2026-09-22T10:11:12.400Z"
};
